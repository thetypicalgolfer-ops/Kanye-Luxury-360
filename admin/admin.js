...
const DB = {
    ...
    getListings() {
        return this.get('listings', [
            { id:'1', title:'Limestone & Steel Contemporary Estate', location:'The Dominion · San Antonio, TX', price:4250000, beds:5, baths:6, sqft:7200, acres:1.2, status:'Active', tag:'Just Listed', visibility:'both', image:'../img-estate-1.png?v=7', photos:[], description:'A breathtaking fusion of natural limestone and steel. 5 beds, 6 baths, chef\'s kitchen, resort pool.', createdAt: new Date(Date.now()-2*86400000).toISOString() },
            { id:'2', title:'Architectural Modern Home', location:'Alamo Heights · San Antonio, TX', price:2895000, beds:4, baths:4.5, sqft:4800, acres:0.5, status:'Active', tag:'Active', visibility:'both', image:'../img-estate-3.png?v=7', photos:[], description:'Clean lines, floor-to-ceiling glass, and bespoke finishes define this masterwork.', createdAt: new Date(Date.now()-7*86400000).toISOString() },
            { id:'3', title:'Hill Country Legacy Ranch', location:'Boerne · Texas Hill Country', price:6800000, beds:4, baths:3, sqft:3800, acres:340, status:'Active', tag:'Ranch Land', visibility:'both', image:'../img-estate-2.png?v=6', photos:[], description:'340 pristine acres, ag-exempt, with a custom 4-bed lodge and multiple water features.', createdAt: new Date(Date.now()-14*86400000).toISOString() },
            { id:'4', title:'Stone Oak Executive Estate', location:'Stone Oak · San Antonio, TX', price:1975000, beds:5, baths:4, sqft:4200, acres:0.8, status:'Pending', tag:'Under Contract', visibility:'listings', image:'../img-stone-oak.png?v=6', photos:[], description:'Impeccably maintained estate in the heart of Stone Oak\'s premier gated community.', createdAt: new Date(Date.now()-21*86400000).toISOString() },
            { id:'5', title:'New Braunfels Waterfront Estate', location:'New Braunfels · Comal County, TX', price:3450000, beds:6, baths:5, sqft:5600, acres:2.1, status:'Active', tag:'Waterfront', visibility:'listings', image:'../img-new-braunfels.png?v=6', photos:[], description:'Stunning river-front estate with private boat dock, infinity pool, and 6 en-suite bedrooms.', createdAt: new Date(Date.now()-5*86400000).toISOString() },
            { id:'6', title:'Fredericksburg Wine Country Estate', location:'Fredericksburg · Gillespie County, TX', price:5200000, beds:4, baths:4, sqft:4900, acres:75, status:'Off-Market', tag:'Off-Market', visibility:'listings', image:'../img-fredericksburg.png?v=6', photos:[], description:'75-acre Hill Country estate surrounded by vineyards. Private guest cottage, pool, and event barn.', createdAt: new Date(Date.now()-30*86400000).toISOString() },
        ]);
    },
