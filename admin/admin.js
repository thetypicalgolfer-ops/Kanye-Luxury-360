...
const DB = {
    ...
    getListings() {
        return this.get('listings', [
            ...
            { id:'4', title:'Stone Oak Executive Estate', location:'Stone Oak · San Antonio, TX', price:1975000, beds:5, baths:4, sqft:4200, acres:0.8, status:'Pending', tag:'Under Contract', visibility:'listings', image:'../img-stone-oak-1.png', photos:[], description:'Impeccably maintained estate in the heart of Stone Oak\'s premier gated community.', createdAt: new Date(Date.now()-21*86400000).toISOString() },
